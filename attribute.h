 ...
 */
#define EZB_COLD __attribute__((cold))
 ...
 */
#define EZB_MALLOC_LIKE __attribute__((malloc))
 ...
 */
#define EZB_PRINTF_LIKE(index) __attribute__((format(printf,index,index + 1)))
 ...
 */
#define EZB_PURE __attribute__((const))
 ...
 */
#define EZB_UNUSED __attribute__((unused))
