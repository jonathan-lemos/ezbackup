 ...
 *
 * @return An empty dynamic string, or NULL on failure.
 ...
 *
 * @return A dynamic copy of that string, or NULL on failure.
 * This string must be free()'d when no longer in use.
 */
 ...
 *
 * @param in A dynamic string.
 * This pointer is free()'d once this function completes, regardless of if it succeeds or not.
 ...
 *
 * @param in A string containing a path.
 * This path does not necessarily have to exist.
 *
 * @return The path's corresponding filename.
 * Note that this value is a pointer within the input string.
 ...
 * This path does not necessarily have to exist.
 *
 * @return The path's corresponding extension.
 * Note that this value is a pointer within the input string.
 * Therefore if the input string is changed, this pointer is no longer valid.
 */
 ...
 * This path does not necessarily have to exist.
 *
 * @return The path's parent directory, or NULL if it does not exist or there was an error.
 * This string must be free()'d when no longer in use.
 */
 ...
 *
 * @return The current directory, or NULL on error.
 * This string must be free()'d when no longer in use.
 */
char* sh_getcwd(void);
 ...
 * This can be NULL.
 *
 * @return For two non-null strings, the return value is the same as strcmp().
 * Otherwise:
 ...
 * This can be NULL
 *
 * @return Same as sh_cmp_nullsafe() while treating capital letters as equal to lowercase ones.
 * @see sh_cmp_nullsafe()
 */
 ...
 *
 * @return A string corresponding to the format string filled in with its arguments, or NULL on error.
 * This string must be free()'d when no longer in use.
 */
