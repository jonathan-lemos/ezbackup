...
.PHONY: linecount
linecount:
	wc -l makefile readme.txt $(foreach dir,$(DIRECTORIES),$(dir)/*.h $(dir)/*.c $(dir)/*.cpp) $(foreach test,$(TESTS),$(test).c) $(foreach cxxtest,$(CXXTESTS),$(cxxtest).cpp) tests/test_framework.h tests/test_framework.c
